...
public class SignUp {
	...
	public static void main(String[] args) {
		...
		String title_sign_up_expected = "Sign Up";
	...
	//TC-001.01 ////////////////
	    ...
	    if (title_sign_up_expected.equals(title_sign_up_actual)){
			...
			System.out.println("Title Expected / Actulal: \t" + title_sign_up_expected + " / " + title_sign_up_actual);
			System.out.println("================================================================================");		}
	    else{
	...
	//TC-001.02 ////////////////
	    ...
	    if (title_facebook_expected.equals(title_facebook_actual)){
			...
			System.out.println("Title Expected / Actulal: \t" + title_facebook_expected + " / " + title_facebook_actual);
		    System.out.println("================================================================================");		}
